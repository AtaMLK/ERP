...
const functional=spawnSync(process.execPath,['scripts/production-functional.js'],{stdio:'inherit'});if(functional.status!==0)failed++;
if(!process.env.DATABASE_URL)console.log('DB-dependent tests require DATABASE_URL and are skipped.');
